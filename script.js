...
switch (preferedLanguage()) { //remember, that this function is declared in /common_resources/languageDetecion.js file; don't forget to link that in html file!
    case "pl": //Polish
        ...
        stringLangDesc="Aplikacje te zawierają obsługę języka polskiego, niemieckiego, ukraińskiego i angielskiego. Język jest ustawiany zgodnie z ustawieniami przeglądarki użytkownika. W przypadku braku jakiegokolwiek z wymienionych, wybierany jest język angielski.";
    ...
    case "de": //German
        ...
        stringLangDesc="Diese Anwendungen bieten Unterstützung für Polnisch, Deutsch, Ukrainisch und Englisch. Die Sprache wird entsprechend den Browsereinstellungen des Benutzers eingestellt. Wenn alle diese Einstellungen fehlen, wird Englisch ausgewählt.";
    ...
    case "uk": //Ukrainian
        ...
        stringLangDesc="Ці застосунки включають підтримку польської, німецької, української та англійської мов. Мова встановлюється відповідно до налаштувань браузера користувача. Якщо всі вони відсутні, вибирається англійська";
    ...
    case "en":
        ...
        stringLangDesc="These applications include support for Polish, German, Ukrainian and English. Language is set according to user's browser settings. If all of these are missing, English is selected.";
